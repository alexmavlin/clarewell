...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    getConsultations: function getConsultations() {
      var _this = this;
      _api__WEBPACK_IMPORTED_MODULE_0__["default"].get('/api/auth/commoncontrollers/formbuilder/index').then(function (res) {
        _this.consultations = res.data;
...
var render = function render() {
  ...
  }, [_vm._m(0), _vm._v(" "), _c("tbody", _vm._l(_vm.consultations, function (consultation) {
    return _c("tr", [_c("td", [_vm._v(_vm._s(consultation.name))]), _vm._v(" "), _c("td", [_vm._v(_vm._s(consultation.sections.length))]), _vm._v(" "), _c("td", [_c("router-link", {
      attrs: {
        to: {
...
var staticRenderFns = [function () {
  var _vm = this,
    _c = _vm._self._c;
  return _c("thead", [_c("tr", [_c("th", [_vm._v("Form title")]), _vm._v(" "), _c("th", [_vm._v("Sections")]), _vm._v(" "), _c("th", [_vm._v("Actions")])])]);
}];
