                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            ...
                            <div class="input-group col-6">
                                <input v-model="serchBarText" @input="searchPatients()" type="text" class="form-control" placeholder="Patient's username, email, phone... etc.">
...
export default {
    ...
    methods: {
        getPatients() {
            ...
            API.get('/api/auth/roles/receptionists/patients/index', {params: {searchBarData: getQuery}})
                .then(res => {
