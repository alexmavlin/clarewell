...
export default {
    ...
    methods: {
        ...
        patientSearchFunction() {
            this.$router.push({name: 'receptionists.patients', query: {searchBarData: this.patientSearch.data}})
            document.getElementById('header__search--window').classList.remove('active')
        },
        appointmentSearchFunction() {
            this.$router.push({name: 'receptionists.appointments', query: {searchBarData: this.appointmentSearch.data}})
            document.getElementById('header__search--window').classList.remove('active')
        },
        colleaguesSearchFunction() {
            this.$router.push({name: 'receptionists.colleagues', query: {searchBarData: this.colleaguesSearch.data}})
            document.getElementById('header__search--window').classList.remove('active')
        }
    }
}
