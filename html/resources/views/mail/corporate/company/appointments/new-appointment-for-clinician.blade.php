...
<p style="font-size:14px;">
    Patient: 
    <span style="font-weight:600">{{ $data['patient']['name'] }}</span>
</p>
<p style="font-size:14px;">
    <b>Contact info</b><br> 
    Email: 
    <span style="font-weight:600">{{ $data['patient']['email'] }}</span><br>
    Phone:
    <span style="font-weight:600">{{ $data['patient']['phone'] }}</span><br>
</p>
<p style="font-size:14px;">
    Appointment details: 
